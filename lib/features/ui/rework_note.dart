...
class ReworkNote extends StatelessWidget {
  const ReworkNote({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: const [
                TableCell(label: 'REWORK NOTE NO:', width: 140),
            ...
            Row(
              children: const [
                TableCell(label: 'REWORK QTY.', width: 140),
                ExpandedEmptyCell(flex: 3),
                ExpandedTextCell(label: 'ID NO', flex: 2),
                ExpandedEmptyCell(flex: 2),
              ],
            ),
            ...
            Row(
              ...
              children: const [
                ExpandedTableCell(label: "INSPECTION NAME / SIGN"),
                ExpandedTableCell(label: "SHIFT INCHARGE NAME"),
              ],
            ),
          ],
        ),
